...
def parse_args():
    ...
    # Model parameters
    parser.add_argument("--llava_version_or_path", type=str, default="/weka/oe-training-default/jamesp/code/gantry/VideoGLaMM/VideoGPTPlus-Phi3-SAM2-8frame-tunevlproj-epoch29")
